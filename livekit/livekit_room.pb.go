...
type CreateRoomRequest struct {
	...
	ConfigName string `protobuf:"bytes,12,opt,name=config_name,json=configName,proto3" json:"config_name,omitempty"`
	...
	// agent
	Agent *RoomAgent `protobuf:"bytes,11,opt,name=agent,proto3" json:"agent,omitempty"`
...
func (x *CreateRoomRequest) GetConfigName() string {
	if x != nil {
		return x.ConfigName
	}
	return ""
...
func (x *CreateRoomRequest) GetAgent() *RoomAgent {
	if x != nil {
		return x.Agent
	}
	return nil
...
type RoomAgent struct {
	...
	Agents []*StartAgentJobRequest `protobuf:"bytes,1,rep,name=agents,proto3" json:"agents,omitempty"`
}
...
func (x *RoomAgent) GetAgents() []*StartAgentJobRequest {
	if x != nil {
		return x.Agents
	}
	return nil
...
type CreateRoomConfigurationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Configuration *RoomConfiguration `protobuf:"bytes,1,opt,name=configuration,proto3" json:"configuration,omitempty"`
}

func (x *CreateRoomConfigurationRequest) Reset() {
	*x = CreateRoomConfigurationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateRoomConfigurationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateRoomConfigurationRequest) ProtoMessage() {}

func (x *CreateRoomConfigurationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_room_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateRoomConfigurationRequest.ProtoReflect.Descriptor instead.
func (*CreateRoomConfigurationRequest) Descriptor() ([]byte, []int) {
	return file_livekit_room_proto_rawDescGZIP(), []int{19}
}

func (x *CreateRoomConfigurationRequest) GetConfiguration() *RoomConfiguration {
	if x != nil {
...
type UpdateRoomConfigurationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // configuration to update
	// number of seconds to keep the room open if no one joins
	EmptyTimeout *uint32 `protobuf:"varint,2,opt,name=empty_timeout,json=emptyTimeout,proto3,oneof" json:"empty_timeout,omitempty"`
	// number of seconds to keep the room open after everyone leaves
	DepartureTimeout *uint32 `protobuf:"varint,3,opt,name=departure_timeout,json=departureTimeout,proto3,oneof" json:"departure_timeout,omitempty"`
	// limit number of participants that can be in a room
	...
	// egress
	Egress *RoomEgress `protobuf:"bytes,5,opt,name=egress,proto3,oneof" json:"egress,omitempty"`
	// agent
	Agent *RoomAgent `protobuf:"bytes,6,opt,name=agent,proto3,oneof" json:"agent,omitempty"`
	// playout delay of subscriber
	MinPlayoutDelay *uint32 `protobuf:"varint,7,opt,name=min_playout_delay,json=minPlayoutDelay,proto3,oneof" json:"min_playout_delay,omitempty"`
	MaxPlayoutDelay *uint32 `protobuf:"varint,8,opt,name=max_playout_delay,json=maxPlayoutDelay,proto3,oneof" json:"max_playout_delay,omitempty"`
	// improves A/V sync when playout_delay set to a value larger than 200ms. It will disables transceiver re-use
	// so not recommended for rooms with frequent subscription changes
	SyncStreams *bool `protobuf:"varint,9,opt,name=sync_streams,json=syncStreams,proto3,oneof" json:"sync_streams,omitempty"`
}

func (x *UpdateRoomConfigurationRequest) Reset() {
	*x = UpdateRoomConfigurationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateRoomConfigurationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRoomConfigurationRequest) ProtoMessage() {}

func (x *UpdateRoomConfigurationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_room_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRoomConfigurationRequest.ProtoReflect.Descriptor instead.
func (*UpdateRoomConfigurationRequest) Descriptor() ([]byte, []int) {
	return file_livekit_room_proto_rawDescGZIP(), []int{20}
}

func (x *UpdateRoomConfigurationRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UpdateRoomConfigurationRequest) GetEmptyTimeout() uint32 {
...
func (x *UpdateRoomConfigurationRequest) GetDepartureTimeout() uint32 {
...
func (x *UpdateRoomConfigurationRequest) GetMaxParticipants() uint32 {
...
func (x *UpdateRoomConfigurationRequest) GetEgress() *RoomEgress {
	if x != nil {
		return x.Egress
	}
	return nil
...
func (x *UpdateRoomConfigurationRequest) GetAgent() *RoomAgent {
	if x != nil {
		return x.Agent
	}
	return nil
...
func (x *UpdateRoomConfigurationRequest) GetMinPlayoutDelay() uint32 {
	if x != nil && x.MinPlayoutDelay != nil {
		return *x.MinPlayoutDelay
	}
	return 0
}

func (x *UpdateRoomConfigurationRequest) GetMaxPlayoutDelay() uint32 {
	if x != nil && x.MaxPlayoutDelay != nil {
		return *x.MaxPlayoutDelay
	}
	return 0
}

func (x *UpdateRoomConfigurationRequest) GetSyncStreams() bool {
	if x != nil && x.SyncStreams != nil {
		return *x.SyncStreams
	}
	return false
}

type ListRoomConfigurationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // If non empty, return only the configurartion with this name
}

func (x *ListRoomConfigurationRequest) Reset() {
	*x = ListRoomConfigurationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRoomConfigurationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRoomConfigurationRequest) ProtoMessage() {}

func (x *ListRoomConfigurationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_room_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRoomConfigurationRequest.ProtoReflect.Descriptor instead.
func (*ListRoomConfigurationRequest) Descriptor() ([]byte, []int) {
	return file_livekit_room_proto_rawDescGZIP(), []int{21}
}

func (x *ListRoomConfigurationRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type ListRoomConfigurationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Configurations []*RoomConfiguration `protobuf:"bytes,1,rep,name=configurations,proto3" json:"configurations,omitempty"`
}

func (x *ListRoomConfigurationResponse) Reset() {
	*x = ListRoomConfigurationResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRoomConfigurationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRoomConfigurationResponse) ProtoMessage() {}

func (x *ListRoomConfigurationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_room_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRoomConfigurationResponse.ProtoReflect.Descriptor instead.
func (*ListRoomConfigurationResponse) Descriptor() ([]byte, []int) {
	return file_livekit_room_proto_rawDescGZIP(), []int{22}
}

func (x *ListRoomConfigurationResponse) GetConfigurations() []*RoomConfiguration {
	if x != nil {
...
type RoomConfiguration struct {
	...
	// agent
	Agent *RoomAgent `protobuf:"bytes,6,opt,name=agent,proto3" json:"agent,omitempty"`
	// playout delay of subscriber
	MinPlayoutDelay uint32 `protobuf:"varint,7,opt,name=min_playout_delay,json=minPlayoutDelay,proto3" json:"min_playout_delay,omitempty"`
	MaxPlayoutDelay uint32 `protobuf:"varint,8,opt,name=max_playout_delay,json=maxPlayoutDelay,proto3" json:"max_playout_delay,omitempty"`
	// improves A/V sync when playout_delay set to a value larger than 200ms. It will disables transceiver re-use
...
func (x *RoomConfiguration) GetAgent() *RoomAgent {
	if x != nil {
		return x.Agent
	}
	return nil
...
var file_livekit_room_proto_rawDesc = []byte{
	...
	,
	...
	0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2b, 0x0a, 0x06, 0x65,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73,
	0x52, 0x06, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x28, 0x0a, 0x05, 0x61, 0x67, 0x65, 0x6e,
	0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x69, 0x6e, 0x5f, 0x70, 0x6c, 0x61, 0x79, 0x6f, 0x75,
	...
	0x73, 0x52, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0x42, 0x0a, 0x09, 0x52, 0x6f, 0x6f,
	0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x35, 0x0a, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74,
	0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x4a, 0x6f, 0x62, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x28, 0x0a,
	...
	0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x38, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x6f, 0x6f, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a, 0x05,
	0x72, 0x6f, 0x6f, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x05, 0x72, 0x6f, 0x6f, 0x6d,
	0x73, 0x22, 0x27, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x52,
	...
	0x22, 0x2d, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70,
	0x61, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72,
	0x6f, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x22,
	0x58, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61,
	0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x0c, 0x70,
	...
	0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x73, 0x22, 0x49, 0x0a, 0x17, 0x52, 0x6f, 0x6f,
	0x6d, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01,
	...
	0x74, 0x69, 0x74, 0x79, 0x22, 0x1b, 0x0a, 0x19, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x61,
	0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x79, 0x0a, 0x14, 0x4d, 0x75, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x54, 0x72, 0x61,
	0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6f,
	...
	0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x72, 0x61,
	0x63, 0x6b, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x72,
	0x61, 0x63, 0x6b, 0x53, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x22, 0x41, 0x0a, 0x15,
	0x4d, 0x75, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x05, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x18, 0x01,
	...
	0xba, 0x01, 0x0a, 0x18, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63,
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x3e, 0x0a, 0x0a, 0x70, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xd4, 0x01, 0x0a,
	...
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x49, 0x0a, 0x12, 0x70, 0x61, 0x72, 0x74,
	0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x18, 0x05,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x50,
	...
	0x73, 0x65, 0x22, 0xf2, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x18, 0x01,
	...
	0x74, 0x2e, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x2d, 0x0a, 0x10,
	0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x64, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0f, 0x64, 0x65, 0x73, 0x74,
	...
	0x65, 0x73, 0x12, 0x19, 0x0a, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a,
	0x06, 0x5f, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x12, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x44,
	0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4b, 0x0a, 0x19, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x62, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a, 0x0d, 0x63, 0x6f,
	...
	,
	...
	0x1d, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42,
	0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74,
	...
	0x6e, 0x73, 0x22, 0xf6, 0x02, 0x0a, 0x11, 0x52, 0x6f, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	,
	...
	0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x12, 0x21, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x74,
	0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18,
	0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x60, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61,
	...
	,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x46, 0x5a, 0x23,
...
var file_livekit_room_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_livekit_room_proto_goTypes = []interface{}{
	...
	(*CreateRoomConfigurationRequest)(nil), // 19: livekit.CreateRoomConfigurationRequest
	(*UpdateRoomConfigurationRequest)(nil), // 20: livekit.UpdateRoomConfigurationRequest
	(*ListRoomConfigurationRequest)(nil),   // 21: livekit.ListRoomConfigurationRequest
	(*ListRoomConfigurationResponse)(nil),  // 22: livekit.ListRoomConfigurationResponse
	(*RoomConfiguration)(nil),              // 23: livekit.RoomConfiguration
	...
	(*StartAgentJobRequest)(nil),           // 27: livekit.StartAgentJobRequest
	...
	(DataPacket_Kind)(0),                   // 33: livekit.DataPacket.Kind
}
var file_livekit_room_proto_depIdxs = []int32{
	1,  // 0: livekit.CreateRoomRequest.egress:type_name -> livekit.RoomEgress
	2,  // 1: livekit.CreateRoomRequest.agent:type_name -> livekit.RoomAgent
	...
	27, // 5: livekit.RoomAgent.agents:type_name -> livekit.StartAgentJobRequest
	28, // 6: livekit.ListRoomsResponse.rooms:type_name -> livekit.Room
	29, // 7: livekit.ListParticipantsResponse.participants:type_name -> livekit.ParticipantInfo
	30, // 8: livekit.MuteRoomTrackResponse.track:type_name -> livekit.TrackInfo
	31, // 9: livekit.UpdateParticipantRequest.permission:type_name -> livekit.ParticipantPermission
	32, // 10: livekit.UpdateSubscriptionsRequest.participant_tracks:type_name -> livekit.ParticipantTracks
	33, // 11: livekit.SendDataRequest.kind:type_name -> livekit.DataPacket.Kind
	23, // 12: livekit.CreateRoomConfigurationRequest.configuration:type_name -> livekit.RoomConfiguration
	1,  // 13: livekit.UpdateRoomConfigurationRequest.egress:type_name -> livekit.RoomEgress
	2,  // 14: livekit.UpdateRoomConfigurationRequest.agent:type_name -> livekit.RoomAgent
	23, // 15: livekit.ListRoomConfigurationResponse.configurations:type_name -> livekit.RoomConfiguration
	1,  // 16: livekit.RoomConfiguration.egress:type_name -> livekit.RoomEgress
	2,  // 17: livekit.RoomConfiguration.agent:type_name -> livekit.RoomAgent
	0,  // 18: livekit.RoomService.CreateRoom:input_type -> livekit.CreateRoomRequest
	3,  // 19: livekit.RoomService.ListRooms:input_type -> livekit.ListRoomsRequest
	5,  // 20: livekit.RoomService.DeleteRoom:input_type -> livekit.DeleteRoomRequest
	7,  // 21: livekit.RoomService.ListParticipants:input_type -> livekit.ListParticipantsRequest
	9,  // 22: livekit.RoomService.GetParticipant:input_type -> livekit.RoomParticipantIdentity
	9,  // 23: livekit.RoomService.RemoveParticipant:input_type -> livekit.RoomParticipantIdentity
	11, // 24: livekit.RoomService.MutePublishedTrack:input_type -> livekit.MuteRoomTrackRequest
	13, // 25: livekit.RoomService.UpdateParticipant:input_type -> livekit.UpdateParticipantRequest
	14, // 26: livekit.RoomService.UpdateSubscriptions:input_type -> livekit.UpdateSubscriptionsRequest
	16, // 27: livekit.RoomService.SendData:input_type -> livekit.SendDataRequest
	18, // 28: livekit.RoomService.UpdateRoomMetadata:input_type -> livekit.UpdateRoomMetadataRequest
	19, // 29: livekit.RoomService.CreateRoomConfiguration:input_type -> livekit.CreateRoomConfigurationRequest
	20, // 30: livekit.RoomService.UpdateRoomConfiguration:input_type -> livekit.UpdateRoomConfigurationRequest
	21, // 31: livekit.RoomService.ListRoomConfiguration:input_type -> livekit.ListRoomConfigurationRequest
	28, // 32: livekit.RoomService.CreateRoom:output_type -> livekit.Room
	4,  // 33: livekit.RoomService.ListRooms:output_type -> livekit.ListRoomsResponse
	6,  // 34: livekit.RoomService.DeleteRoom:output_type -> livekit.DeleteRoomResponse
	8,  // 35: livekit.RoomService.ListParticipants:output_type -> livekit.ListParticipantsResponse
	29, // 36: livekit.RoomService.GetParticipant:output_type -> livekit.ParticipantInfo
	10, // 37: livekit.RoomService.RemoveParticipant:output_type -> livekit.RemoveParticipantResponse
	12, // 38: livekit.RoomService.MutePublishedTrack:output_type -> livekit.MuteRoomTrackResponse
	29, // 39: livekit.RoomService.UpdateParticipant:output_type -> livekit.ParticipantInfo
	15, // 40: livekit.RoomService.UpdateSubscriptions:output_type -> livekit.UpdateSubscriptionsResponse
	17, // 41: livekit.RoomService.SendData:output_type -> livekit.SendDataResponse
	28, // 42: livekit.RoomService.UpdateRoomMetadata:output_type -> livekit.Room
	23, // 43: livekit.RoomService.CreateRoomConfiguration:output_type -> livekit.RoomConfiguration
	23, // 44: livekit.RoomService.UpdateRoomConfiguration:output_type -> livekit.RoomConfiguration
	22, // 45: livekit.RoomService.ListRoomConfiguration:output_type -> livekit.ListRoomConfigurationResponse
...
func file_livekit_room_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_room_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateRoomConfigurationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_livekit_room_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateRoomConfigurationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_livekit_room_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRoomConfigurationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_livekit_room_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRoomConfigurationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_livekit_room_proto_msgTypes[16].OneofWrappers = []interface{}{}
	file_livekit_room_proto_msgTypes[20].OneofWrappers = []interface{}{}
	type x struct{}
